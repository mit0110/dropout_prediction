...
class KDDCupCoEmbeddedLSTMModelTest(unittest.TestCase):
    ...
    def test_build_network(self):
        ...
        model = KDDCupEmbeddedLSTMModel(self.dataset, **self.model_arguments)
    ...
    def test_build_with_embeddings(self):
        ...
        model = KDDCupEmbeddedLSTMModel(
            self.dataset, embedding_model=embedding_model,
            **self.model_arguments)
        model.build_all()
        resulting_embeddings = model.sess.run(model.embedding_var)
        numpy.testing.assert_array_equal(resulting_embeddings,
